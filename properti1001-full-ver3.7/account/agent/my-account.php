						...
						<div class="span12 tab-accountl tab-acc jrk">
							...
							<div class="row-fluid jrk">
								<div class="span12 bg-ket-acc-dsb">
									<div class="span3 bg-ket-acc-dsb-img">
									...
									<div class="span3 bg-ket-acc-dsb-img">
										...
										<img src="../../assets/img/penj-credit.jpg">
										<h3 class="h3--penj">Isi Saldo Credit Anda</h3>
										<p class="p--penj">Isilah saldo credit anda untuk melakukan transaksi porperti anda dengan mudah. Silahkan isi Credit 
										<br><br><a href="#" class="btn btn-warning" style="margin:0px 0px 0px 0px;padding:2px 10px;"> Disini <i class="icon-circle-arrow-right"></i></a></p>
									</div>
									<div class="span3 bg-ket-acc-dsb-img">
										<div class="circle4"><div class="circle5"><p>3</p></div></div>
										<img src="../../assets/img/penj-paket.jpg">
										<h3 class="h3--penj">Dapatkan Paket Properti Anda</h3>
										<p class="p--penj">Gunakanlah Credit anda dalam pembelian Paket properti. Paket properti berguna dalam mempostingkan properti anda. Silahkan beli Paket properti 
										<br><br><a href="#" class="btn btn-warning" style="margin:0px 0px 0px 0px;padding:2px 10px;"> Disini <i class="icon-circle-arrow-right"></i></a></p>
									</div>
									<div class="span3 bg-ket-acc-dsb-img">
										<div class="circle4"><div class="circle5"><p>4</p></div></div>
										<img src="../../assets/img/penj-posting.jpg">
										<h3 class="h3--penj">Posting Properti Anda</h3>
										<p class="p--penj">Setelah anda memiliki Paket properti, anda sudah dapat melakukan posting properti untuk penjualan dan penyewaan properti anda. Silahkan posting properti 
										<br><br><a href="#" class="btn btn-warning" style="margin:0px 0px 0px 0px;padding:2px 10px;"> Disini <i class="icon-circle-arrow-right"></i></a></p>
									</div>
								</div>
							</div>
							...
							<div class="row-fluid jrk">
								<div class="span12 bg-ket-acc-dsb">									
									<div class="span5 bg-ket-acc-dsb-text">
										<div class="circle2"><div class="circle3"><p>5</p></div></div>
										<h3>Inbox Message</h3>
										<p>Anda bisa melihat pesan yang dikirim oleh calon pembeli kepada Anda.</p>
									</div>
									<div class="span7 bg-ket-acc-dsb-img">
										<img src="../../assets/img/acc-img/imginbox.jpg">
									</div>
								</div>
							</div>
							...
							<div class="row-fluid jrk">
								<div class="span12 bg-ket-acc-dsb">									
									<div class="span5 bg-ket-acc-dsb-text">
										<div class="circle2"><div class="circle3"><p>6</p></div></div>
										<h3>Contact Customer Support</h3>
										<p>Anda bisa mengirim pesan kepada customer support kami.</p>
									</div>
									<div class="span7 bg-ket-acc-dsb-img">
										<img src="../../assets/img/acc-img/imgcs.jpg">
									</div>
								</div>
							</div>
