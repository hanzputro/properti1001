...
<html class="no-js">
    ...
    <body>
		...
		<!---- Content ---->
        <div id="wrap" style="">
			<p class="link-navigation-web"><a href="../../../home.php">Home</a> / <a href="../my-credit.php">My Credits</a> / <a href="payment-verify.php">Payment Verify</a></p>
			<!-- #menu -->
            <div id="main-menu">
				<div class="navbar navbar-inverse navbar-static-top">
				...
				<div class="span12">
					<div class="row-fluid">
						<div class="span12 tab-accountl tab-acc jrk">
											...
											<div class="navbar-inner navbar-inner2">
												<div class="container-fluid">				
													<ul class="nav nav-track" style="padding-left:10%;">
														...
														<li><a class="" href="../my-credits/payment-info.php"><div class="circle-untrack"><p><i class="icon-briefcase"></i></p></div><br>2. Payment Info</a></li>
														<li><a class="active-track" href="../my-credits/payment-verify.php"><div class="circle-track"><p><i class="icon-time"></i></p></div><br>3. Payment Status</a></li>
													</ul>
												</div>
											</div>
										</div>
							...
							<p><i>Pembayaran Credits anda akan tertunda untuk di verifikasi oleh team kami dalam waktu 1x24 jam.</i></p>
							<hr style="margin:5px 0px 15px 0px">
							<!----- form pembelian credits ----->
							<h3 style="margin:0px 0px 5px 0px;color:#ffa200;">Transaksi Tertunda</h3>
							<form id="" class="">
								<ul class="nav nav-tabs smpn-pcrn">											
									...
									<div class="controls-search">
										<font class="pull-left" style="margin:7px 0px 0px 5px; color:#03a0ef; font-size:16px; letter-spacing:0px;">
											...
											dari--><font style="color:#ffa200; font-weight:bold; letter-spacing:0px;"> 3</font> Pembayaran Tertunda
										</font>
										...
										<table class="table table6 table-condensed table-bordered table-striped">
											...
											<tbody>
												<tr>
													...
													<td class="isi-table-credit">10</td>
