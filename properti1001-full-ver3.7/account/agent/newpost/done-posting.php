											...
											<div class="navbar-inner navbar-inner2">
												<div class="container-fluid">
													<ul class="nav nav-track" style="padding-left:10%;">														
														...
														<li><a class="active-track" href="javascript:void(0)" style="cursor:default; color:#aaa; background:#fff;"><div class="circle-track"><p><i class="icon-ok"></i></p></div><br>3. Done</a></li>														
													</ul>
												</div>
											</div>
										</div>
