...
<html class="no-js">
    ...
    <body>
		...
		<!---- Content ---->
        <div id="wrap" style="">
			<p class="link-navigation-web"><a href="../../home.php">Home</a> / <a href="my-listing.php">My Listing</a></p>
			<!-- #menu -->
            <div id="main-menu">
				<div class="navbar navbar-inverse navbar-static-top">
					...
					<div class="row-fluid">
						<div class="span12 tab-accountl tab-acc jrk">
							...
							<div class="alert alert-danger">
								Anda belum memiliki Listing, silahkan membuat listing anda 
								<a href="newpost-listing.php" class="btn btn-warning" style="margin:-8px 0px -4px 5px;padding:2px 50px;"> Buat Disini <i class="icon-circle-arrow-right"></i></a>
								...
								<ul class="nav nav-tabs smpn-pcrn">											
									...
									<div class="controls-search">
										<font class="pull-left" style="margin:7px 0px 0px 5px; color:#03a0ef; font-size:16px; letter-spacing:0px;">
											Menampilkan <font style="color:#ffa200; font-weight:bold; letter-spacing:0px;"> 0</font> Listing Properti
										</font>
									...
									<div id="" class="" style="margin:0px;">
										<table class="table table6 table-condensed table-bordered">
											<thead>
												<tr>
													<th class="title-table-credit">Your Listing</th>
												</tr>
											</thead>
											<tbody>
												<!---- list-view ---->
															...
															<div class="span12 view-list">
																<div class="row-fluid">
																		...
																		<div class="row-fluid">
																			...
																			<div class="span8 bg-desc-agnt">
																				<div class="row-fluid">
																					...
																					<!-- /Icon Dijual, Disewa, Terjual, Tersewa -->	
																					<div class="span10 title-prop-list">
																	...
																	<div class="row-fluid">
																		...
																		<p class="detail btn-i pull-right" style=""><i class="icon-spinner" style="color:#03a0ef;"></i> Status: Pending</p>
																		<a href="#PremiumListingModal" data-original-title="Help" data-toggle="modal" class="detail btn btn-i pull-right" style=""><i class="icon-star" style="color:#ffa200;"></i> Upgrade Ke Premium</a>
																		<a href="#" class="detail btn btn-i pull-right" style=""><i class="icon-ok-sign" style="color:green;"></i> Telah Terjual / Tersewa</a>
																		<a href="#" class="apus btn pull-left" style="margin-left:6px;"><i class="icon-remove-sign" style="color:#fc3e3e;"></i> Hapus</a>
																		<a href="../my-listing/newpost/detail-posting.php" class="edit btn pull-left" style=""><i class="icon-cog" style="color:#5f3a3a;"></i> Edit</a>																		
																		<!--<a href="#PremiumListingModal" data-original-title="Help" data-toggle="modal" class="premium btn pull-left" style=""><i class="icon-star" style="color:#ffa200;"></i> Premium Listing</a>-->
																		</div>
																	</div>
																</div>														
															</div>
		...
		<!---- login-modal ---->
		<?php 
			include "../../component/premiumlisting-modal.php";
		?>			
		<!---- /login-modal ---->	
