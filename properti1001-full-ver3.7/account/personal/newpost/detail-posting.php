											...
											<div class="navbar-inner navbar-inner2">
												<div class="container-fluid">
													<ul class="nav nav-track" style="padding-left:50px;">														
														...
														<li><a class="" href="done-posting.php" style="color:#aaa; background:#fff;"><div class="circle-untrack"><p><i class="icon-ok"></i></p></div><br>3. Status Posting</a></li>														
													</ul>
												</div>
											</div>
										</div>
