...
<html class="no-js">
    ...
    <body>
		...
		<!---- Content ---->
        <div id="wrap" style="">
			<p class="link-navigation-web"><a href="../../../home.php">Home</a> &raquo; <a href="../my-account.php">My Personal Account</a> &raquo; <a href="email-peringatan.php">Email Alerts</a></p>
			<!-- #menu -->
            <div id="main-menu">
				<div class="navbar navbar-inverse navbar-static-top">
