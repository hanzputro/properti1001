...
<html class="no-js">
    ...
    <body>
		...
		<!---- Content ---->
        <div id="wrap" style="">
			<p class="link-navigation-web"><a href="../../../home.php">Home</a> &raquo; <a href="../my-account.php">My Personal Account</a> &raquo; <a href="properti-pilihan.php">favorite properties</a></p>
			<!-- #menu -->
            <div id="main-menu">
				<div class="navbar navbar-inverse navbar-static-top">
							...
							<div id="main-account-menu">
								<div class="navbar navbar-inverse navbar-static-top">
									<div class="navbar-inner navbar-inner2">
										<div class="container-fluid">				
											<ul class="nav nav5">
												<li><a class="" href="../my-account.php"><i class="icon-briefcase"></i> PERSONAL ACCOUNT</a></li>
					...
					<div class="row-fluid">
						<div class="span3 tab-accountk2 tab-acc">
							<div class="navbar-acc">
								<ul class="nav nav6">
									<li><a class="active-acc" href="properti-pilihan.php">favorite properties <i class="icon-heart-empty" style="float:right; font-size:16px;"></i></a></li>
							...
							<div class="row-fluid jrk">
								<div class="span12 bg-ket-acc-dsb">									
									<div class="span5 bg-ket-acc-dsb-text">
										<div class="circle2"><div class="circle3"><p><i class="icon-heart"></i></p></div></div>
								...
								<ul class="nav nav-tabs smpn-pcrn">									
									...
									<div class="controls-search">
										<font class="pull-left" style="margin:7px 0px 7px 5px; color:#03a0ef; font-size:16px; letter-spacing:0px;">
											...
											dari--><font style="color:#ffa200; font-weight:bold; letter-spacing:0px;"> 2</font> Properti Favorit
										</font>
										<!--
									...
									<div id="" class="" style="margin:0px;">
										<table class="table table6 table-condensed table-bordered table-striped">
											<thead>
												<tr>
													<th class="title-table-credit">Your favorite properties</th>
												</tr>
											</thead>
											<tbody>
												<tr>
