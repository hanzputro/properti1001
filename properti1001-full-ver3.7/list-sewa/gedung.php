...
<html class="no-js">
    ...
    <body>
        ...
        <div id="wrap"><!---- Content ---->
			<p class="link-navigation-web"><a href="../home.php">Home</a> / <a href="gedung.php">Sewa Gedung</a></p>
			<!-- #menu -->
            <div id="main-menu">
				<div class="navbar navbar-inverse navbar-static-top">
								...
								<div class="span12 img-srcbox">
									<div class="row-fluid">
										...
										<div class="span6 img-bg-list">
											<p class="p-title-img-list">PENYEWAAN <font class="" style="margin-left:130px;">GEDUNG</font></p>
											<p class="p2-desc-img-list">Properti1001 menyewakan berbagai macam properti di semua rentang harga.</p>
											<img src="../assets/img/bg-prop/gedung.jpg" alt="" style="height:170px; width:100%; border-radius:4px 0px 0px 4px;"/>
										</div>
										<!----- /image ----->
															...
															<div class="control-group">
																...
																<div class="row-fluid">
																	<div class="span3">
																		<div class="controls">
																			<select data-placeholder="" class="span12 select-mini select2" tabindex="4">
																				<option selected>Kamar Tidur (semua)</option>
																				<option>1 Kamar Tidur</option>
																				<option>2 Kamar Tidur</option>
																				<option>3 Kamar Tidur</option>
																				<option>4 Kamar Tidur</option>
																				<option>5 Kamar Tidur</option>
																			</select>
																		</div>
																	</div>
																	<div class="span4">
																		...
																		<div class="span4">
																			<div class="row-fluid">
																				<div class="span12 bg-premium-list">
																					<font><i class="icon-tags" style="color:#ffd800;"></i> Gedung</font>
																		...
																		<div class="span8 bg-desc-agnt">
																			...
																			<div class="row-fluid">
																				<div class="span12 price-prop-list">
																					<p class="">Rp 500.000.000 <font>/tahun</font></p>
																				</div>
																			</div>	
																			<div class="row-fluid">
																				<div class="span12">
																...
																<div class="span12 view-list-in">
																	<div class="row-fluid">
																		...
																		<div class="span8 bg-desc-agnt">
																			...
																			<div class="row-fluid">
																				<div class="span12 price-prop-list">
																					<p class="">Rp 999.000.000 <font>/bulan</font></p>
																				</div>
																			</div>	
																			<div class="row-fluid">
																				<div class="span12">
