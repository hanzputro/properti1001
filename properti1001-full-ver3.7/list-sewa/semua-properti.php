...
<html class="no-js">
    ...
    <body>
        ...
        <div id="wrap"><!---- Content ---->
			<p class="link-navigation-web"><a href="../home.php">Home</a> / <a href="apartemen.php">Sewa Semua Properti</a></p>
			<!-- #menu -->
            <div id="main-menu">
				<div class="navbar navbar-inverse navbar-static-top">
				...
				<div class="span12">
					<div class="row-fluid">				
						<div class="span9">
								...
								<div class="span12 img-srcbox">
									<div class="row-fluid">
										...
										<div class="span6 img-bg-list">
											<p class="p-title-img-list">PENYEWAAN <font class="" style="margin-left:50px;">SEMUA PROPERTI</font></p>
							...
							<!---- premiumlistingsewa-slider ---->
							<?php 
								include "../component/premiumlistingsewa-slider.php";
							?>	
							<!---- /premiumlistingsewa-slider ---->
