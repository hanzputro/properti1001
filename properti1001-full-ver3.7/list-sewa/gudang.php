...
<html class="no-js">
    ...
    <body>
        ...
        <div id="wrap"><!---- Content ---->
			<p class="link-navigation-web"><a href="../home.php">Home</a> / <a href="gudang.php">Sewa Gudang</a></p>
			<!-- #menu -->
            <div id="main-menu">
				<div class="navbar navbar-inverse navbar-static-top">
								...
								<div class="span12 img-srcbox">
									<div class="row-fluid">
										...
										<div class="span6 img-bg-list">
											<p class="p-title-img-list">PENYEWAAN <font class="" style="margin-left:130px;">GUDANG</font></p>
											<p class="p2-desc-img-list">Properti1001 menyewakan berbagai macam properti di semua rentang harga.</p>
											<img src="../assets/img/bg-prop/gudang.jpg" alt="" style="height:170px; width:100%; border-radius:4px 0px 0px 4px;"/>
										</div>
										<!----- /image ----->
																		...
																		<div class="span4">
																			<div class="row-fluid">
																				<div class="span12 bg-premium-list">
																					<font><i class="icon-tags" style="color:#ffd800;"></i> Gudang</font>
